package com.abbey.vgabbey.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.abbey.vgabbey.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.abbey.vgabbey.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.abbey.vgabbey.domain.User.class.getName());
            createCache(cm, com.abbey.vgabbey.domain.Authority.class.getName());
