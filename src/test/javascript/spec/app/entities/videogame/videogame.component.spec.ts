...
import { VideogameComponent } from 'app/entities/videogame/videogame.component';
...
describe('Component Tests', () => {
  describe('Videogame Management Component', () => {
    let comp: VideogameComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VideogameComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.videogames && comp.videogames[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
